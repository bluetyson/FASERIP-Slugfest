...
class CreatureBase:
    ...
    def __init__(self):
        ...
        self.alt_attack = {'throwing-blunt':0,'throwing-edged':0,'blunt':0,'edged':0,'shooting':0,'energy':0,'force':0,'grappling':0,'armour-piercing':0,'mental':0,'magic':0,'power':0}  #put other abilities/weapons here
