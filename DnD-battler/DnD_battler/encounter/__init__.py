...
class Encounter(EncounterAction):
    ...
    TODO: update this for FASERIP to detail how things work
    ...
    targeted spell attack —produce flame is a cantrip so could be written up as a weapon. The bigger ones. Spell slots need to be re-written.
